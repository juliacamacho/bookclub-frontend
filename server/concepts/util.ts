...
const operations: operation[] = [
  ...
  },
  {
    ...
    endpoint: "/api/friends/requests/:to",
    method: "POST",
    fields: { to: "input" },
  },
  {
  ...
  },
  {
    ...
    endpoint: "/api/friends/accept/:from",
    method: "PUT",
    fields: { from: "input" },
  },
  {
    name: "Reject Friend Request",
    endpoint: "/api/friends/reject/:from",
    method: "PUT",
    fields: { from: "input" },
  },
  // {
  ...
  {
    name: "Get Reading Invitiations Received",
    endpoint: "/api/invitations/received",
    method: "GET",
    fields: {},
  },
  {
    name: "Get Reading Invitiations Posted",
    endpoint: "/api/invitations/posted",
    method: "GET",
    fields: {},
  },
  {
    name: "Post Reading Invitation",
    endpoint: "/api/books/:bookId/invitation",
    method: "POST",
    fields: { bookId: "input" },
  },
  {
    name: "Accept Reading Invitation",
    endpoint: "/api/invitations/:id/accept",
    method: "PATCH",
    fields: { id: "input" },
  },
  {
    name: "Decline Reading Invitation",
